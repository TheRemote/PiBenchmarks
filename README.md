...
<ul>
  <li>Removed Ubuntu PPA as it doesn't support focal and is no longer necessary as libraspberrypi-bin is now available in the Ubuntu repositories now that the Pi is "officially supported" on Ubuntu</li>
